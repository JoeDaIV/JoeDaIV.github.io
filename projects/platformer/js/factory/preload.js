(function (window) {
    ...
    opspark.preload = function (game) {
        ...
        game.load.image('dub', './asset/collectable/database.png');
        game.load.image('stead', './asset/collectable/steve-head.png');
        game.load.image('find', './asset/collectable/grace-head.png');
        game.load.image('sparkz', './asset/collectable/kennedi-head.png');
        game.load.image('bumbleb', './asset/collectable/max-head.png');
